...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 26BD648CE15
	for <lists+v9fs-developer@lfdr.de>; Wed, 12 Jan 2022 22:56:48 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1n7lbo-0003kz-5P; Wed, 12 Jan 2022 21:56:44 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1n7lbm-0003ks-9Z
 for v9fs-developer@lists.sourceforge.net; Wed, 12 Jan 2022 21:56:42 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=akkQ6Ecla+xiqsXojAcBOs9ebFPCv7cFDXlXcfhJ6J8=; b=HDvcUsGRu1vOxJ2v1GdoB7HaLx
 FlvR0xS5ynBKKThOpR60ea4C5W8WiAXZLyLpIExtwyF4DJLXU8GBYUSbjMIPvqOC91H7/vDdPMZZG
 p0UM2xw2XDMW14amAaV0J3hwunQ/+BECL0oS8RlPtNINZ9RLt1EwybZhFxoywCE0C1PU=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=akkQ6Ecla+xiqsXojAcBOs9ebFPCv7cFDXlXcfhJ6J8=; b=Pu60KsM/tbr9g44FvAHOdQBdLJ
 DuHjbdtZLOJAXX8731WZ1Z8duKXvzsg4LoaKVZLMW35mqd4meup/sWZEVOlpjDDb3RO9XSbosW/it
 2KbLOOnh+DyoRcCmYEM6de+pGxADGp7019sAc3XJ/5BJLzJcVtOqbOL02PgmkNdK2FxM=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1642024588;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=akkQ6Ecla+xiqsXojAcBOs9ebFPCv7cFDXlXcfhJ6J8=;
 b=i3ibyYQ1PRl0EnWkOBXMygtgqAIbGtYdgLnB3iKyn08vmLVL0odDGGhGZg/r/VwOdOhSfI
 XyXcRjY1Lei+YOafYC19c9fwjCSHNIn7mkkQup8TA60nbpdS18Otc9buGdYopeqv+NuPq7
 ML7PWPDkx1ysRCF2cB8oUuyutvCCPug=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-300-lpOH86hQNbKrKK8Q6wM25g-1; Wed, 12 Jan 2022 16:56:24 -0500
X-MC-Unique: lpOH86hQNbKrKK8Q6wM25g-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 16C20100C609;
 Wed, 12 Jan 2022 21:56:23 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.165])
 by smtp.corp.redhat.com (Postfix) with ESMTP id C62E14E2BD;
 Wed, 12 Jan 2022 21:56:19 +0000 (UTC)
...
MIME-Version: 1.0
Content-ID: <1318952.1642024578.1@warthog.procyon.org.uk>
Date: Wed, 12 Jan 2022 21:56:18 +0000
Message-ID: <1318953.1642024578@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  [Note: This has been detached from my fscache-rewrite pull
 request and stacked on the branch after the tag point] Change the cifs
 filesystem
 to take account of the changes to fscache's indexing rewrite and reenable
 caching in cifs. 
...
X-Headers-End: 1n7lbe-00DoqR-MQ
Subject: [V9fs-developer] [PATCH v6] cifs: Support fscache indexing rewrite
...
Cc: Shyam Prasad N <nspmangalore@gmail.com>, linux-cifs@vger.kernel.org,
 ...
 Steve French <smfrench@gmail.com>, linux-fsdevel@vger.kernel.org,
...
[Note: This has been detached from my fscache-rewrite pull request and stacked
 on the branch after the tag point]
...
---
 ...
 fs/cifs/inode.c    |   37 +++--
 11 files changed, 207 insertions(+), 509 deletions(-)
...
index 96d083db1737..b29e651edb21 100644
--- a/fs/cifs/inode.c
+++ b/fs/cifs/inode.c
...
@@ -1376,12 +1373,19 @@ struct inode *cifs_root_iget(struct super_block *sb)
 		inode = ERR_PTR(rc);
 	}
...
+	}
 ...
 out:
 	kfree(path);
@@ -2270,6 +2274,8 @@ cifs_dentry_needs_reval(struct dentry *dentry)
 int
...
@@ -2279,7 +2285,8 @@ cifs_invalidate_mapping(struct inode *inode)
 				 __func__, inode);
 	}
...
@@ -2784,8 +2791,10 @@ cifs_setattr_unix(struct dentry *direntry, struct iattr *attrs)
 		goto out;
...
@@ -2980,8 +2989,10 @@ cifs_setattr_nounix(struct dentry *direntry, struct iattr *attrs)
