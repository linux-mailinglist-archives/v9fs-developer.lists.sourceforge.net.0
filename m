...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BAC430BC83
	for <lists+v9fs-developer@lfdr.de>; Tue,  2 Feb 2021 12:04:56 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1l6tUL-00038O-0Q; Tue, 02 Feb 2021 11:04:53 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <dhowells@redhat.com>) id 1l6tUJ-00037m-9c
 for v9fs-developer@lists.sourceforge.net; Tue, 02 Feb 2021 11:04:51 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=SVGYKHIcPo6tueTdXNVLBjjSO7ZYj2ZvN2dKNlpOlHI=; b=HxtTrAbfwqj1Juz190Fp6TyM6Y
 ERE/U5wbK2fyTBrFcn5r/peAR4nfnYet1m1G1pyRy0Hd2Z3C4Frm8bwh9+jAEcWU0A35zos31gKiN
 lf9zofJ+9Z4boiuexiELXhM1a4U46wtZdGPKVY3BE4l6dy/f9jMBa485TQ7KO+e7JOiY=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=SVGYKHIcPo6tueTdXNVLBjjSO7ZYj2ZvN2dKNlpOlHI=; b=GYpe8jB8KYV/baIehOvd/4vb6l
 xZBV9HlBVbEYyhzB4NriEmEJ663ZLbFTUlIT3aV1SY3Cqe1ELNE/e44L8+breY66WhgWrbTMkmD2t
 vYKmlFn4LcnaXvibQKobQl4U27sFOx72c+IBw28C3DVo1bR3YKrxTStU4d4toGzvtqEE=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1612263872;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding;
 bh=SVGYKHIcPo6tueTdXNVLBjjSO7ZYj2ZvN2dKNlpOlHI=;
 b=HNWwzuGGyGEttySuk5WveKFp25gYr29L0ZBNQefLVqHI5RNDPGl1MFS8jDmRkjUgmNN60u
 8F3kquMFvuWvUqNrRc4reFTwcpEske0KKp6WT1D2dOd0R6D1I1mtE4VfAU8pko6yfBAuHK
 fzQW1U5anE1rcCNsoidYUTPWdli3pFY=
...
X-Headers-End: 1l6tU6-00EPID-LB
Subject: [V9fs-developer] [PATCH] 9p: Convert to cut-down fscache I/O API
 rewrite
...
@@ -99,39 +43,5 @@ static inline void v9fs_cache_inode_set_cookie(struct inode *inode, struct file
 {
 }
...
@@ -159,17 +157,14 @@ static int v9fs_vfs_writepage_locked(struct page *page)
 	else
 		len = PAGE_SIZE;
...
+	p9_client_write(v9inode->writeback_fid, start, &from, &err);
 	...
 	return err;
@@ -205,14 +200,13 @@ static int v9fs_vfs_writepage(struct page *page, struct writeback_control *wbc)
...
@@ -256,35 +250,24 @@ static int v9fs_write_begin(struct file *filp, struct address_space *mapping,
...
@@ -324,7 +307,7 @@ static int v9fs_write_end(struct file *filp, struct address_space *mapping,
