...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 3802265059D
	for <lists+v9fs-developer@lfdr.de>; Mon, 19 Dec 2022 00:24:57 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1p731b-0002f9-RB;
	Sun, 18 Dec 2022 23:24:55 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <evanhensbergen@icloud.com>) id 1p731b-0002f3-3H
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=UKXPxnOVOmFmz8taPT0O6GjmM2XIDmBokAiQGyxCAWk=; b=QCdAEvF7bB3sroCorSQbsd8YFp
 +pv+kcKbEsQXWrWroD81LFh4+sSCtb72BllnqCrLswV73QfzJrdY32gt1h4AbsfZ+ehYbS1KJUSC7
 L1faBmGY7kyZcBSkLEQNzxeyBDdz/MlQ8ZlLRqgtcSbS11T6BwpDHDsOtSWBL1WU/ISg=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=UKXPxnOVOmFmz8taPT0O6GjmM2XIDmBokAiQGyxCAWk=; b=YRDtIL6BhuwOyOPkrXnEernDux
 WbIhdRPudtjqb/ukv19IPsm/V7FPOWIdC56y6BPvpL71wT0x2Ik33LK6j4/6XZG1yr6iSPRvIEgNV
 eRQOoigt1sui3C4l63U03CDgjr9NgA9gtdcrs7twX/dRl2AFy7pj0mcMthZmJ4oNrb64=;
Received: from ms11p00im-qufo17281301.me.com ([17.58.38.50])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1p731Z-0003Ma-P8 for v9fs-developer@lists.sourceforge.net;
 Sun, 18 Dec 2022 23:24:55 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  This fixes several detected problems from preivous patches
 when running with writeback mode. In particular this fixes issues with files
 which are opened as write only and getattr on files which dirty [...] 
...
X-Headers-End: 1p731Z-0003Ma-P8
Subject: [V9fs-developer] [PATCH v2 10/10] writeback mode fixes
