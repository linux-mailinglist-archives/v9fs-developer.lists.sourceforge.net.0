...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F922437E32
	for <lists+v9fs-developer@lfdr.de>; Fri, 22 Oct 2021 21:11:23 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mdzwo-0004Tm-8m; Fri, 22 Oct 2021 19:11:22 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <dhowells@redhat.com>) id 1mdzwn-0004Tb-HH
 for v9fs-developer@lists.sourceforge.net; Fri, 22 Oct 2021 19:11:21 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=pduq8JmaLiep+zXaU6TdGnEE18u1qfpZkDtSvQZfn/k=; b=cRM5r+ExNdhtwQ9kvYxJX+7ghS
 KFf6KwSQAUdR9RofH84rc7eU0ti4a06h3gXN5UCS90MrOHWah3jaZoI7p7F/xkRD76FyKk9IPPkFA
 qBMPwY8Lzkm3Yn76bpXNv3IhZPZfasT1H2CP09Oxb2cChYf3WI4zqVPYtS9C2lGCR2Ic=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=pduq8JmaLiep+zXaU6TdGnEE18u1qfpZkDtSvQZfn/k=; b=Eav4s3Uu/FJLVLy6geTUY1Xb1O
 lFpYBzCuoLkj6UkIcPaEtrusC3rQY8hm3W2yqwFM6kXRWgpx6Q6h5Z3gunQraz+Ik9EA2/yRrxuXb
 tpiZmA56QVAubQ3mcpFgiOPl/70kxRwg/rBB3I+yCvoLxufBycz+BmE3APyoQwR89NYo=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1634929873;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=pduq8JmaLiep+zXaU6TdGnEE18u1qfpZkDtSvQZfn/k=;
 b=RcxeFdVaY/GoK1B7+YaLHCMy6262MxSY8X1YJ3OkPliUtgrr/bMWjNe5eUT4zMbeQ8OCwM
 5nT+DEtv15oXPeIkMVc7eWLiiadv6+l/Eg9FqgfD8YEViqXcEQAmz7799XLybMp2IkB1Hy
 eQnSsG9G8Gu/VR5ji9bx/4RWyU58MWA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-44-Jmbd5BFZMeikjuKuqCI06g-1; Fri, 22 Oct 2021 15:10:01 -0400
X-MC-Unique: Jmbd5BFZMeikjuKuqCI06g-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com
 [10.5.11.23])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 7468F801FCE;
 Fri, 22 Oct 2021 19:09:59 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.19])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 728CD19723;
 Fri, 22 Oct 2021 19:09:53 +0000 (UTC)
...
Date: Fri, 22 Oct 2021 20:09:52 +0100
Message-ID: <163492979259.1038219.8722617502632790512.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Change the 9p filesystem to take account of the changes to
 fscache's indexing rewrite and reenable caching in 9p. The following changes
 have been made: (1) The fscache_netfs struct is no more, and there's no need
 to register the filesystem as a whole. 
...
X-Headers-End: 1mdzwl-00CIBm-OP
Subject: [V9fs-developer] [PATCH v2 48/53] 9p: Use fscache indexing rewrite
 and reenable caching
...
index b940c5ffd9e3..e485049eec85 100644
--- a/fs/9p/cache.h
+++ b/fs/9p/cache.h
@@ -9,25 +9,14 @@
 #define _9P_CACHE_H
...
index cff99f5c05e3..5bcc2ab5b277 100644
--- a/fs/9p/vfs_addr.c
+++ b/fs/9p/vfs_addr.c
...
index b6a5a0be444d..676b8b00ef20 100644
--- a/fs/9p/vfs_dir.c
+++ b/fs/9p/vfs_dir.c
@@ -19,6 +19,7 @@
 #include <linux/idr.h>
