...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C55540AFE8
	for <lists+v9fs-developer@lfdr.de>; Tue, 14 Sep 2021 15:56:45 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mQ8vT-0000Eg-QV; Tue, 14 Sep 2021 13:56:43 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <dhowells@redhat.com>) id 1mQ8vR-0000EX-Od
 for v9fs-developer@lists.sourceforge.net; Tue, 14 Sep 2021 13:56:41 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=gUMRBDTIXogdaeU8DUZKMueDQ7+rJ+ZckxQlsZalGt0=; b=R+N2v96hw9ABwDJXyhqX8+ZObP
 yCynqCdcqWX2o7ZlqxksbFx6jL5A6DJO/4jLti87dQVW35ZUVYa9khjKfioZQC5iNJKIBMW0fwdd6
 Az5wjfLE+moG9P6qPAix1B52J7dMTN3MPVsO7CaTJDR2Huf2S3IjhM3RwrFQlYG8ceIQ=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=gUMRBDTIXogdaeU8DUZKMueDQ7+rJ+ZckxQlsZalGt0=; b=Qgmsk+MmtSY8v+XEa/zL2u4GB8
 uR3IZ/y+ajLeL+YJpW4yKpeGgABbCrSK3gpBiQlyi4HXeqMCJmfzEbua37PSU05k7l9uepQkK3cvV
 8ym0TMJ6uez3KqTxlJiBYGV9E8FTdqOEpJl4okBu9KaAza2rDMiSldwjDIk6XC4a7CGs=;
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 id 1mQ8vN-00ARlh-Vc
 for v9fs-developer@lists.sourceforge.net; Tue, 14 Sep 2021 13:56:39 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1631627792;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=gUMRBDTIXogdaeU8DUZKMueDQ7+rJ+ZckxQlsZalGt0=;
 b=ILq0ca0AaAzUpJXxro7yMuallowZfhKCEgkOyThBNiO9tWDtNYtyLwPNvHZGiWuL9R6n1N
 uDo3a0aGIUCq/BzDaB/cSRQSB4qzVi0DENGYpuk2qiIPkO+OZTpHNdCpIBIU6y/z+R5ChA
 ONn7V4Unz44P0X+uyi12Z2vWhkQaIZ0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-352-XeTyjhn7NuKfBBLSu8TjaA-1; Tue, 14 Sep 2021 09:56:30 -0400
X-MC-Unique: XeTyjhn7NuKfBBLSu8TjaA-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com
 [10.5.11.23])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 01B6A1808305;
 Tue, 14 Sep 2021 13:56:29 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.44])
 by smtp.corp.redhat.com (Postfix) with ESMTP id D5A261948C;
 Tue, 14 Sep 2021 13:56:22 +0000 (UTC)
...
Date: Tue, 14 Sep 2021 14:56:22 +0100
Message-ID: <163162778200.438332.1918683687532006409.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Update the fscache documentation to remove the old I/O API
 bits and to note the new fallback API. Signed-off-by: David Howells
 <dhowells@redhat.com> cc: linux-cachefs@redhat.com ---
 Documentation/filesystems/caching/backend-api.rst
 | 138 -------- Documentation/filesystems/caching/netfs-api.rst | 386 ++ 2
 files changed, 47 insertions(+), 477 deletions(-) 
...
X-Headers-End: 1mQ8vN-00ARlh-Vc
Subject: [V9fs-developer] [PATCH 8/8] fscache: Update the documentation to
 reflect I/O API changes
...
---
 ...
 Documentation/filesystems/caching/netfs-api.rst   |  386 ++-------------------
 2 files changed, 47 insertions(+), 477 deletions(-)
...
index d9f14b8610ba..407871d78f72 100644
...
-
 ...
 ===================================
@@ -412,277 +366,55 @@ some point in the future, and as such, it may happen after the function returns
...
+functions, but there is a fallback API, though this is deprecated as it may
+lead to data corruption, depending on the characteristics of the backing
+filesystem.  If the fallback API is to be used, the filesystem must do::
...
+	int fscache_deprecated_read_page(struct fscache_cookie *cookie,
+					 struct page *page);
...
@@ -858,39 +590,3 @@ to have reached a point at which it can start submitting ordinary operations
 once again::
