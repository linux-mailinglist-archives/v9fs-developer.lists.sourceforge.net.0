...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C14621DBF4
	for <lists+v9fs-developer@lfdr.de>; Mon, 13 Jul 2020 18:29:34 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1jv1Ke-0005Uo-Vt; Mon, 13 Jul 2020 16:29:32 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <dhowells@redhat.com>) id 1jv1Ke-0005Uh-7T
 for v9fs-developer@lists.sourceforge.net; Mon, 13 Jul 2020 16:29:32 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=88uT1q21DTmOhVOfEvsusPbEg8eFBMaVuECMzfonzT4=; b=BITf67p7x498D2Ut3b3vn74ThQ
 0wiQS/cz5Gc1MuP8ZsrCvucXFAxWPLpEQ5exfNceG9IlinSGrF64WMeGWM9sViTM4RV0PLQvYU1s/
 UkvhRQju0aiL0YI4LwbkFPFcdCJ2wjcKucncDOOeULIAuze6IjVKOsbNqPxJJcPttmi8=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=88uT1q21DTmOhVOfEvsusPbEg8eFBMaVuECMzfonzT4=; b=JIk7uQDqFvUDGaNC+rHJqMH44N
 sYxdsmok4A2R1Vb14/GClrcrztgiVxzeL8lA4JD78RDtrTftpAVzw81zvGa3cSmwBDWnDU+cNkdAA
 lLbkjIqydGGyNd/c1/yIqCJhQ2sBfW8L1OgI3lgfpr2smZ9UYFE9lXXroGWo2aVEsw6A=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1594657757;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=88uT1q21DTmOhVOfEvsusPbEg8eFBMaVuECMzfonzT4=;
 b=VZ0MlUrM4V9fYKss70niEj2mngMpjCuSmdSEBPWiEY3/WWuDBS6LTVBuEl6OA71Yh7el/3
 ik28iOiA2mmayVzS7YdAP7ukbtt5FR6snb8Fie3/sHhbNjbnkN49ay/rTrfDAZS8eJ6/CJ
 80+OuH0T8OpRdc4cJJCFxvQiVPPjCSM=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-194-HYgBWlEaN9aIaSi-AljOnA-1; Mon, 13 Jul 2020 12:29:13 -0400
X-MC-Unique: HYgBWlEaN9aIaSi-AljOnA-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 3A9AD10CE781;
 Mon, 13 Jul 2020 16:29:11 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-112-113.rdu2.redhat.com
 [10.10.112.113])
 by smtp.corp.redhat.com (Postfix) with ESMTP id BE7C96FEDF;
 Mon, 13 Jul 2020 16:29:05 +0000 (UTC)
...
Date: Mon, 13 Jul 2020 17:29:05 +0100
Message-ID: <159465774502.1376105.9572590179043153178.stgit@warthog.procyon.org.uk>
...
X-Headers-End: 1jv1Kc-00GHzr-8B
Subject: [V9fs-developer] [PATCH 07/14] fscache: Remove struct
 fscache_cookie_def
...
index 9326361582a6..7fdc39b1c965 100644
--- a/fs/afs/cell.c
+++ b/fs/afs/cell.c
@@ -607,7 +607,9 @@ static int afs_activate_cell(struct afs_net *net, struct afs_cell *cell)
...
index c29d042e8292..0a4623c38cf5 100644
--- a/fs/afs/inode.c
+++ b/fs/afs/inode.c
...
index 792ac711985e..4ec6a463081f 100644
--- a/fs/afs/internal.h
+++ b/fs/afs/internal.h
@@ -882,13 +882,6 @@ extern void afs_merge_fs_addr6(struct afs_addr_list *, __be32 *, u16);
  */
 #ifdef CONFIG_AFS_FSCACHE
...
index 40e5cc3d572f..5e3fe894a0f9 100644
--- a/fs/afs/volume.c
+++ b/fs/afs/volume.c
