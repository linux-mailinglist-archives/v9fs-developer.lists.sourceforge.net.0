...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 9099C4CABD0
	for <lists+v9fs-developer@lfdr.de>; Wed,  2 Mar 2022 18:30:51 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nPSoL-0005Q8-R2; Wed, 02 Mar 2022 17:30:48 +0000
...
Subject: Re: [V9fs-developer] [Intel-gfx] [PATCH 6/6] treewide: remove check
