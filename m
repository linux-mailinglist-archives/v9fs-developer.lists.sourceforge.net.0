...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E32146EEA8
	for <lists+v9fs-developer@lfdr.de>; Thu,  9 Dec 2021 17:58:05 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mvMk6-0002Ip-NN; Thu, 09 Dec 2021 16:58:03 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1mvMk6-0002Ij-1q
 for v9fs-developer@lists.sourceforge.net; Thu, 09 Dec 2021 16:58:03 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=WeVgmd6jjJqy97wMP60jm8y0OiHOjaVH1BOYiwiSu6g=; b=hDpzO9iJIEwTSyTetVjXz/HpFg
 wWxbgifVOAjtGXoCBI7GvlCvWhWmo4B8Cq/ldpSfC/BOUGF8vYm5i5OG0lcDnZp6YW3YbVMHXfbRE
 vIntiGQAtVYM4MBiLuSMHyCzuzRsKHSm6NqVHMdhVJMrwB3WKxlWjrMmTGnhX2O/2raE=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=WeVgmd6jjJqy97wMP60jm8y0OiHOjaVH1BOYiwiSu6g=; b=TaFzwNv4DD4rcTV8mi8prmfB7W
 UhX2jthqLTEiqH8nq/C6qcMxTBUfJCg7XAHtsemNR5Gj9KvWNo45pr3Tr31FUWTvsB7V09gAWIpOj
 kk6V2xLhCN20K45Un4doNwliPVNXWSMoal/PFTOFWSKzGhbqS94NhJNR+GWkH5Llvnxo=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1639069076;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=WeVgmd6jjJqy97wMP60jm8y0OiHOjaVH1BOYiwiSu6g=;
 b=bvowIXGL6vwU7ZU3VeFJuWKp4NE6FjgXZ6ENZWtCoCBJPMoWJf5debcMTTqACOqP/CyQzI
 RoZs0iBWCUcKK82HGzv9nQ0ysO9682EAh6m2E/lFE9pZ0aKEsBbWjFuQqROqg85wfwVC2f
 nQUcp+bH/NhjlQkAWWxOEypQQPQluko=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-551-NebZLBPwOZ2U5L-hmlcPVA-1; Thu, 09 Dec 2021 11:57:52 -0500
X-MC-Unique: NebZLBPwOZ2U5L-hmlcPVA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 6DEAE10247AA;
 Thu,  9 Dec 2021 16:57:50 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.122])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 19F301010426;
 Thu,  9 Dec 2021 16:57:19 +0000 (UTC)
...
Date: Thu, 09 Dec 2021 16:57:19 +0000
Message-ID: <163906903925.143852.1805855338154353867.stgit@warthog.procyon.org.uk>
...
X-Headers-End: 1mvMk5-0000qX-Th
Subject: [V9fs-developer] [PATCH v2 17/67] fscache: Implement simple cookie
 state machine
...
index 96d0adfc3040..91ace2e8b596 100644
...
@@ -93,9 +107,8 @@ void fscache_end_cookie_access(struct fscache_cookie *cookie,
...
@@ -166,35 +179,58 @@ static inline void wake_up_cookie_state(struct fscache_cookie *cookie)
...
@@ -287,10 +323,10 @@ static struct fscache_cookie *fscache_alloc_cookie(
...
@@ -412,6 +448,192 @@ struct fscache_cookie *__fscache_acquire_cookie(
 }
...
+
  ...
  */
@@ -426,21 +648,27 @@ static void fscache_unhash_cookie(struct fscache_cookie *cookie)
 	hlist_bl_lock(h);
...
@@ -467,12 +695,13 @@ void __fscache_relinquish_cookie(struct fscache_cookie *cookie, bool retire)
