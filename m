...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F9103F4D14
	for <lists+v9fs-developer@lfdr.de>; Mon, 23 Aug 2021 17:12:31 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mIBcj-0006VU-25; Mon, 23 Aug 2021 15:12:29 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <groeck7@gmail.com>) id 1mIBci-0006VO-2c
 for v9fs-developer@lists.sourceforge.net; Mon, 23 Aug 2021 15:12:28 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=glsVm3RqzgVIRj8dlGS0GV9R6abZS+EPRBwu7DUdpRE=; b=RVjMGrjNeTYQMLiCG5+3j9tfev
 a4OV9Iqpcg++rslKL2lmu0Q3x4oq6Ew5wB53PUCbFXzEeG/5pEDtEGmauVVkDGgttIDLVYPp/RHwx
 BPEIYTTvC2IbePiaU/+xH0TOMSBuBKZHRVoYg9cL0bsYsR/d51oBPAXS+cAr2U/AovCA=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=glsVm3RqzgVIRj8dlGS0GV9R6abZS+EPRBwu7DUdpRE=; b=lqfRf9tyOfqFmLex+qjUNEtXSC
 ZkHeIaHod9XJv2EFkOh+PI9CajdympgPXkmajKM3I4QwC5d2bFE+IMPV32TtN+gIuQtlY6S8hNwNF
 zmu4DGxHcjf60SUsxyBBHml3W0qfUKxJALNuO1aHV41pdoHaojs6oNq0TxjzFAQNkCEI=;
...
Received: by mail-ot1-f46.google.com with SMTP id
 m7-20020a9d4c87000000b0051875f56b95so37132633otf.6
 for <v9fs-developer@lists.sourceforge.net>;
 Mon, 23 Aug 2021 08:12:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=sender:date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=glsVm3RqzgVIRj8dlGS0GV9R6abZS+EPRBwu7DUdpRE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=glsVm3RqzgVIRj8dlGS0GV9R6abZS+EPRBwu7DUdpRE=;
 b=
X-Gm-Message-State: AOAM5305kl58eyScTOavNsh3BUyH53keKBliGb84we34fanKJIwQSri2
 7bybmizHi2arDTboe/Pp+fo=
X-Google-Smtp-Source: ABdhPJyJ5czS6h1Rn8yLUnHyeAc8fE6iKUGAXlI1IWym95rnmTI3fYFfSDHvx3dJqvpj0H4G9i7JDA==
X-Received: by 2002:a9d:d35:: with SMTP id 50mr27267919oti.22.1629731538903;
 Mon, 23 Aug 2021 08:12:18 -0700 (PDT)
Received: from server.roeck-us.net ([2600:1700:e321:62f0:329c:23ff:fee3:9d7c])
 by smtp.gmail.com with ESMTPSA id
 k8sm3382890oom.20.2021.08.23.08.12.17
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 23 Aug 2021 08:12:17 -0700 (PDT)
Date: Mon, 23 Aug 2021 08:12:16 -0700
From: Guenter Roeck <linux@roeck-us.net>
To: Jeff Layton <jlayton@kernel.org>
Message-ID: <20210823151216.GA1122156@roeck-us.net>
...
X-Headers-End: 1mIBce-0002VY-OX
...
> index 2279473d0d6f..0833aea82d87 100644
> --- a/fs/namespace.c
> +++ b/fs/namespace.c
...
>  {
> @@ -3183,8 +3175,8 @@ int path_mount(const char *dev_name, struct path *path,
>  		return ret;
>  	if (!may_mount())
>  		return -EPERM;
...
>  	if (!(flags & MS_NOATIME))
> @@ -3567,9 +3559,8 @@ SYSCALL_DEFINE3(fsmount, int, fs_fd, unsigned int, flags,
