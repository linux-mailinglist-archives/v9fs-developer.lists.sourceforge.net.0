...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 17BA44D4E81
	for <lists+v9fs-developer@lfdr.de>; Thu, 10 Mar 2022 17:18:43 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nSLUw-0000cH-Qi; Thu, 10 Mar 2022 16:18:41 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1nSLUv-0000bz-9W
 for v9fs-developer@lists.sourceforge.net; Thu, 10 Mar 2022 16:18:40 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=fC+mRweQLNvWSrTjqqWRgiMoOB+n42941i0bGOm553A=; b=Y990IJi5iLrMAAd/cT8YHmP4gO
 2HEQOfQIcmO8J0w3+t8raXezM0BATt6VlEnPcLRaf+2jIWQ1ZhGAFZtgAVVOgfk+CX4jrzJ3FCDRh
 WsrxUDlw/cOaw1VY6IeNquo2ql8tZAwNTCaF9VFLqP0cNbt5EfexsyvsP4MoV28yUcR4=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=fC+mRweQLNvWSrTjqqWRgiMoOB+n42941i0bGOm553A=; b=XAzC64W+a8sql6xNlBixIsEuf/
 dn3hU8p2XBWmxFG6ow+vglPMA1OAsEllICrW3FxgU8ON41gi0y/07xBRUQce4nk7owysYcOENnN53
 5UzpvKo03zhdGOkMJ8+epNXWdoz9buoYnv/VpuMaIMX6Ayd3nVJIqGrxiKnb90eGv6bE=;
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.94.2)
 id 1nSLUr-0005yH-Cq
 for v9fs-developer@lists.sourceforge.net; Thu, 10 Mar 2022 16:18:39 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1646929111;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=fC+mRweQLNvWSrTjqqWRgiMoOB+n42941i0bGOm553A=;
 b=ad9HUCnLFKONmYeUQ6+JKdVAk98MiJdq7YatSnCrAWgiGt/imvSrcr2Dy9RkBMEvnRl2dC
 GxVjTTDZmlPqsAL6N3DIaxU0gpTKP1bS44UAnylquStqz2u1jOEMlA/xKjiyCTHqLeo+0/
 cY4yVzrOF6L2l16L7L6vrjevuDvWhOU=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-646-BdOWiMVsOKySfFqQbg9fxw-1; Thu, 10 Mar 2022 11:18:27 -0500
X-MC-Unique: BdOWiMVsOKySfFqQbg9fxw-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id DCC2E801AB2;
 Thu, 10 Mar 2022 16:18:25 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.19])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 6EA4C7AC6B;
 Thu, 10 Mar 2022 16:18:19 +0000 (UTC)
...
Date: Thu, 10 Mar 2022 16:18:18 +0000
Message-ID: <164692909854.2099075.9535537286264248057.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: Add a netfs_i_context struct that should be included in the
 network filesystem's own inode struct wrapper, directly after the VFS's inode
 struct, e.g.: struct my_inode { struct { /* These must be contiguous */ struct
 inode vfs_inode; struct netfs_i_context netfs_ctx; }; }; 
...
X-Headers-End: 1nSLUr-0005yH-Cq
Subject: [V9fs-developer] [PATCH v3 13/20] netfs: Add a netfs inode context
