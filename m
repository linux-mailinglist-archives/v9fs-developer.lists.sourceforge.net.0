...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 1165C5455E0
	for <lists+v9fs-developer@lfdr.de>; Thu,  9 Jun 2022 22:46:30 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nzP2v-0003d9-AC; Thu, 09 Jun 2022 20:46:26 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1nzP2t-0003cy-0y
 for v9fs-developer@lists.sourceforge.net; Thu, 09 Jun 2022 20:46:23 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=HlMubNWTzVeldWvK0uRDTooBxAVT7+LOQUvavvqdR5o=; b=bl6oHtzTI8PEfgqHqnAnG+HD5D
 Xje7LNR+wfy0ZxUMAYlrYqULACqSFrKBS5dBVgon6fxps0FKDI+VNVxe48rallbUL298wqyjLdLPk
 m8i/ZaNtkoFKwHFZm30b24lfzx4lLbLy6rqbwIV7ovvZG5RX0Z8oW3lhZBRx804buLBI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=HlMubNWTzVeldWvK0uRDTooBxAVT7+LOQUvavvqdR5o=; b=GbCj1U8HO8zVnUglsCmGbCZK5A
 Hc3Iks1QUMsAWx6HkOPZWT9fqm1Wc57NChSM8ee5zpkpPvJHT5dwgX/EzoN1EkuLmEWEDGC9FxNZs
 zeaxNtNyFegPW9S7ge9RxyJfAyAMVSKV93ScmShmYuFJELXBjMsY3zTCXt1GV2QGnJ+8=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1654807573;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding;
 bh=HlMubNWTzVeldWvK0uRDTooBxAVT7+LOQUvavvqdR5o=;
 b=A3Ck4TX2ZNHK5y1uWxMls7B78iGJaocrSa/kVSNAOuwAu5LAoGTfp+dtxM4a3cxMAtWiDv
 DqK8zJFEH7INI9arRoX+laR4fRBlTtIqv6GNI/DcyZli+KhUjeiYTGE14bAa/7hmHsVzcl
 eVAsN4WV4e1EGJ8a3EkNRqHgUo4hwgc=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-605-5mhLbRp_OM2pJYQlR-eTRA-1; Thu, 09 Jun 2022 16:46:09 -0400
X-MC-Unique: 5mhLbRp_OM2pJYQlR-eTRA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.rdu2.redhat.com
 [10.11.54.7])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 9BB641C0F694;
 Thu,  9 Jun 2022 20:46:08 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.62])
 by smtp.corp.redhat.com (Postfix) with ESMTP id F22891415100;
 Thu,  9 Jun 2022 20:46:04 +0000 (UTC)
...
MIME-Version: 1.0
Content-ID: <40675.1654807564.1@warthog.procyon.org.uk>
Date: Thu, 09 Jun 2022 21:46:04 +0100
Message-ID: <40676.1654807564@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Can you apply this please? It fixes the gcc-12 warnings
 in netfslib. David --- netfs: Fix gcc-12 warning by embedding vfs inode in
 netfs_i_context 
...
X-Headers-End: 1nzP2n-0002tz-VG
Subject: [V9fs-developer] [PATCH] netfs: Fix gcc-12 warning by embedding vfs
 inode in netfs_i_context
...
Cc: Latchesar Ionkov <lucho@ionkov.net>, linux-doc@vger.kernel.org,
 ...
 Xiubo Li <xiubli@redhat.com>, jlayton@kernel.org, linux-kernel@vger.kernel.org,
...
Can you apply this please?  It fixes the gcc-12 warnings in netfslib.
...
Dave Chinner suggested using a filesystem-specific VFS_I() function in each
filesystem to convert that filesystem's own inode wrapper struct into the
VFS inode struct[4].
...
---
 ...
 40 files changed, 227 insertions(+), 255 deletions(-)
...
index 8ce82ff1e40a..90c6c1ba03ab 100644
--- a/fs/9p/vfs_addr.c
+++ b/fs/9p/vfs_addr.c
...
index a8e8832179e4..4de7af7c2f09 100644
--- a/fs/afs/file.c
+++ b/fs/afs/file.c
...
index a30995901266..984b113a9107 100644
--- a/fs/afs/internal.h
+++ b/fs/afs/internal.h
...
index e5221be6eb55..f5f116ed1b9e 100644
--- a/fs/ceph/addr.c
+++ b/fs/ceph/addr.c
@@ -1798,7 +1798,7 @@ enum {
...
index b7e9cac3aeef..650746b3ba99 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
...
index 12c872800326..c85d9a378325 100644
--- a/fs/cifs/cifsfs.c
+++ b/fs/cifs/cifsfs.c
...
index f873379066c7..e7737166e5b8 100644
...
index 35962a1a23b9..cbc3b433f502 100644
--- a/fs/cifs/misc.c
+++ b/fs/cifs/misc.c
...
index 98a76fa791c0..8543cafdfd34 100644
--- a/fs/cifs/smb2ops.c
+++ b/fs/cifs/smb2ops.c
...
index 8742d22dfd2b..d37e012386f3 100644
...
index 77fa6a61706a..6dbb4c9ce50d 100644
