...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 8199221DBE6
	for <lists+v9fs-developer@lfdr.de>; Mon, 13 Jul 2020 18:29:14 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1jv1KL-0006pJ-A6; Mon, 13 Jul 2020 16:29:13 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <dhowells@redhat.com>) id 1jv1KJ-0006oa-LK
 for v9fs-developer@lists.sourceforge.net; Mon, 13 Jul 2020 16:29:11 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=+f9CmSV+6ATQGeTDvOp6PGTzRNSFSrlUdR4OkFiRLc4=; b=iKlnibvx2ybj3NelVxzcQlBIxa
 kBL2lJBxv1sDLFqfgRjGOuHzm1CbMAx3w6dqMTboJiawcxZ2zLoTYMzUgieFa9aDcvHtDyXw1I6Xn
 QTuiAtD06Zm74YNJWZNXBYP7eOnrmoDHSEkB9x+xg5klgXd+iKhgl00oofakMdwd4Vkc=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=+f9CmSV+6ATQGeTDvOp6PGTzRNSFSrlUdR4OkFiRLc4=; b=Kwo/G/Oa51bKSwl5vVPqaDEAAS
 2uxdYpBmHKDxL0YOxuXWccBzWEqbcAJtpFyxRXX5bsQU1lMj7z2F62nBCKB/DwIdcKafMQj0A2awn
 HtngIR50j1H6EHG4AFCS3y5babaINW6HZtAWxScrzux52NP9etc4EX68ObIDDjC8AD64=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1594657743;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=+f9CmSV+6ATQGeTDvOp6PGTzRNSFSrlUdR4OkFiRLc4=;
 b=NofQ8FU/Xlc+JKckIQYyDnDdkACxCDsJbTD80t4WPG0jbjdtjOOX8ZgaavFKpoKRSLNUI4
 rgkcFE7mtQdg6hHFrlzpETEpqi2duBdr5wO0Xd3ens+BrMiir74k4WFvS38thrpdmfbPPG
 by2iPd2OSkilm/IDP1agYsc7/egS87s=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-319-ImBnepILO6CpxGxc0V6Ccw-1; Mon, 13 Jul 2020 12:29:01 -0400
X-MC-Unique: ImBnepILO6CpxGxc0V6Ccw-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com
 [10.5.11.16])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id C7B441080;
 Mon, 13 Jul 2020 16:28:59 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-112-113.rdu2.redhat.com
 [10.10.112.113])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 07CFE5C1D0;
 Mon, 13 Jul 2020 16:28:53 +0000 (UTC)
...
Date: Mon, 13 Jul 2020 17:28:53 +0100
Message-ID: <159465773322.1376105.8092884103152416955.stgit@warthog.procyon.org.uk>
...
X-Headers-End: 1jv1KH-00GHyN-3g
Subject: [V9fs-developer] [PATCH 06/14] fscache: Remove the netfs data from
 the cookie
...
index 5b79cdceefa0..9326361582a6 100644
--- a/fs/afs/cell.c
+++ b/fs/afs/cell.c
@@ -608,9 +608,10 @@ static int afs_activate_cell(struct afs_net *net, struct afs_cell *cell)
...
index 1d13d2e882ad..c29d042e8292 100644
--- a/fs/afs/inode.c
+++ b/fs/afs/inode.c
...
index 9bc0509e3634..40e5cc3d572f 100644
--- a/fs/afs/volume.c
+++ b/fs/afs/volume.c
