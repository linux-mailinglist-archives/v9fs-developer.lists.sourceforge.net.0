...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C595442983
	for <lists+v9fs-developer@lfdr.de>; Tue,  2 Nov 2021 09:31:57 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mhpD1-0003Wz-Js; Tue, 02 Nov 2021 08:31:55 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1mhpCz-0003Wt-L9
 for v9fs-developer@lists.sourceforge.net; Tue, 02 Nov 2021 08:31:53 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=zi2xgi11RBsiT6yG5p2fKW/AmIf+x3t9kIJ+7cUvxwQ=; b=G7hlRHnTw7FxR5TzJ3ChDf4Xbr
 cnnTDpukqoEX4Mza0Hx9oT2xKXEEH/up+aUYT+brzquEu4lNq1QTa3TfywMmzg/oxt4vzy73fe69K
 oAfgvlXaLMzYDtU6rS6h5MlgsyqbbEcVG3dRHxOXpnAZyNVpSZhoL0mERvHEl/wTyw2c=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=zi2xgi11RBsiT6yG5p2fKW/AmIf+x3t9kIJ+7cUvxwQ=; b=CIsOBFIGlO886n5u7xXP/8q1xy
 YoOU/EFbbl7Fs01gsIyI9jZGkliYbggEhDrp0F5GLrmNzoke8+I1leB21hf4eL+HYVdoTyzesIv3I
 T24XMCyYAGYx1mZghuDy4Kwn4q0MGm5tkrRfzW3SIjVyeBXe8RexzVpMdEUwIDlD1E38=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1635841905;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=zi2xgi11RBsiT6yG5p2fKW/AmIf+x3t9kIJ+7cUvxwQ=;
 b=Mh1d6hgq79QkqJy8r5h1ZxXojG4CdHm0Kf8lIO/yfcu0/DqV5SX428X734mCYxFr5I84KL
 OTL+YAjfvY8f1ZEnp7odMCUjawhTbdggSsc1rFzSIfPYeS2lR77NKgOjVbDBD6mKfjiYpY
 w+3JG9BWyQAxa7YDQM93abC5rZ7P/zI=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-401-N7NdgKgQNBq9s7wZm6Ls-A-1; Tue, 02 Nov 2021 04:31:41 -0400
X-MC-Unique: N7NdgKgQNBq9s7wZm6Ls-A-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 741E81006AA2;
 Tue,  2 Nov 2021 08:31:39 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.19])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 626DF100763D;
 Tue,  2 Nov 2021 08:31:15 +0000 (UTC)
...
Date: Tue, 02 Nov 2021 08:31:14 +0000
Message-ID: <163584187452.4023316.500389675405550116.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Convert the netfs helper library to use folios throughout,
 convert the 9p and afs filesystems to use folios in their file I/O paths
 and convert the ceph filesystem to use just enough folios to compile [...]
 ...
 for more information. [URIs: pv.nr]
 -0.7 DKIMWL_WL_HIGH         DKIMwl.org - High trust sender
X-Headers-End: 1mhpCx-0003Fn-4Y
Subject: [V9fs-developer] [PATCH v3 5/6] netfs, 9p, afs, ceph: Use folios
...
---
 ...
 9 files changed, 422 insertions(+), 416 deletions(-)

diff --git a/fs/9p/vfs_addr.c b/fs/9p/vfs_addr.c
index 2a2368d83868..10f0e65a6a0a 100644
--- a/fs/9p/vfs_addr.c
+++ b/fs/9p/vfs_addr.c
@@ -110,7 +110,9 @@ static const struct netfs_read_request_ops v9fs_req_ops = {
  */
...
+	return netfs_readpage(file, folio, &v9fs_req_ops, NULL);
 ...
 /**
@@ -132,13 +134,15 @@ static void v9fs_vfs_readahead(struct readahead_control *ractl)
...
+		folio_wait_fscache(folio);
 ...
 #endif
 	return 1;
@@ -154,55 +158,55 @@ static int v9fs_release_page(struct page *page, gfp_t gfp)
...
@@ -215,14 +219,15 @@ static int v9fs_vfs_writepage(struct page *page, struct writeback_control *wbc)
...
@@ -265,10 +270,10 @@ v9fs_direct_IO(struct kiocb *iocb, struct iov_iter *iter)
...
@@ -279,31 +284,32 @@ static int v9fs_write_begin(struct file *filp, struct address_space *mapping,
...
+		folio_mark_uptodate(folio);
 	...
 	/*
@@ -314,10 +320,10 @@ static int v9fs_write_end(struct file *filp, struct address_space *mapping,
...
index 8d5e0ef5518e..69e4176297d4 100644
--- a/fs/9p/vfs_file.c
+++ b/fs/9p/vfs_file.c
@@ -529,13 +529,13 @@ static vm_fault_t
...
@@ -543,24 +543,24 @@ v9fs_vm_page_mkwrite(struct vm_fault *vmf)
...
index eb11d047c0ae..58bbcd9ff30f 100644
--- a/fs/afs/file.c
+++ b/fs/afs/file.c
...
index 8b1d9c2f6bec..5319c70e0364 100644
--- a/fs/afs/write.c
+++ b/fs/afs/write.c
...
+	struct folio *folio;
 	...
 	unsigned int f, t;
@@ -456,43 +439,43 @@ static void afs_extend_writeback(struct address_space *mapping,
 		 */
 		rcu_read_lock();
...
@@ -503,8 +486,8 @@ static void afs_extend_writeback(struct address_space *mapping,
...
+			if (!pagevec_add(&pvec, &folio->page))
 			...
 			if (stop)
 				break;
@@ -521,16 +504,16 @@ static void afs_extend_writeback(struct address_space *mapping,
 			break;
...
@@ -544,10 +527,10 @@ static void afs_extend_writeback(struct address_space *mapping,
...
@@ -558,22 +541,22 @@ static ssize_t afs_write_back_from_locked_page(struct address_space *mapping,
...
+	trace_afs_folio_dirty(vnode, tracepoint_string("store"), folio);
 	...
 	len = to - offset;
 	start += offset;
@@ -586,7 +569,7 @@ static ssize_t afs_write_back_from_locked_page(struct address_space *mapping,
...
@@ -596,7 +579,7 @@ static ssize_t afs_write_back_from_locked_page(struct address_space *mapping,
...
@@ -657,16 +640,17 @@ static ssize_t afs_write_back_from_locked_page(struct address_space *mapping,
...
+					       folio, start, LLONG_MAX - start);
 	if (ret < 0) {
 		_leave(" = %zd", ret);
 		return ret;
@@ -683,7 +667,8 @@ static int afs_writepages_region(struct address_space *mapping,
 				 struct writeback_control *wbc,
...
@@ -693,13 +678,14 @@ static int afs_writepages_region(struct address_space *mapping,
 		pgoff_t index = start / PAGE_SIZE;
...
@@ -707,37 +693,38 @@ static int afs_writepages_region(struct address_space *mapping,
...
+		folio_put(folio);
 		if (ret < 0) {
 			_leave(" = %zd", ret);
 			return ret;
@@ -862,7 +849,6 @@ int afs_fsync(struct file *file, loff_t start, loff_t end, int datasync)
...
@@ -870,7 +856,7 @@ vm_fault_t afs_page_mkwrite(struct vm_fault *vmf)
 	unsigned long priv;
...
@@ -880,18 +866,18 @@ vm_fault_t afs_page_mkwrite(struct vm_fault *vmf)
 	 * be modified.  We then assume the entire page will need writing back.
 	 */
 #ifdef CONFIG_AFS_FSCACHE
-	if (PageFsCache(page) &&
...
+	/* We mustn't change folio->private until writeback is complete as that
 	 ...
 	 */
@@ -900,14 +886,14 @@ vm_fault_t afs_page_mkwrite(struct vm_fault *vmf)
 		goto out;
 	}
...
@@ -948,38 +934,38 @@ void afs_prune_wb_keys(struct afs_vnode *vnode)
 /*
