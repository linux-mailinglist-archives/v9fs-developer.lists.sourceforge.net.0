...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C017221E10
	for <lists+v9fs-developer@lfdr.de>; Thu, 16 Jul 2020 10:18:37 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1jvz6B-0002dr-L7; Thu, 16 Jul 2020 08:18:35 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <dhowells@redhat.com>) id 1jv1NY-0007b5-Bp
 for v9fs-developer@lists.sourceforge.net; Mon, 13 Jul 2020 16:32:32 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=fY+zilZiqCzpnqnF7NprcLzXVlf0p9v42SXv6OOR44s=; b=aS0xBB94270gbEtSX/EBxlwqbO
 si/qw0oml2xTspWYLzSUQ7+OtH2Ns1qubb+V2/gIxER3PQUkEnsgt/OAnfysTt1sUNyJLE4F5iwBr
 vQZX+7+85r8MoyCJZJUBC+yru6/u4tE3qIWd4P7jVFfIEs665IGg9483V6ym+vV3kHRA=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=fY+zilZiqCzpnqnF7NprcLzXVlf0p9v42SXv6OOR44s=; b=KnOL6OtF/PmzAXMWJqRml1miE5
 bMV2F28erGFftmMUJVXKEcI9i5xNzxmQvAp0j7x/TZ4AK3HEGHfz7SQstd8uTCsYRRx98BazbhS3Z
 KlUAEyJjOb/ZIYOwbEjTjkmvZRezKHoDU1dUybt6EPnSW62myruUgO7TmPrB/6guom6Q=;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1594657941;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=fY+zilZiqCzpnqnF7NprcLzXVlf0p9v42SXv6OOR44s=;
 b=D1qvJDJhDHdblHxA7scrG51c+7pb/RlueF/BHow7YF05ZfS3+5uArmHKjzHTAwQz4jonsM
 PPRLz9RxQASfMeWzJD6BwcZh6zfIUt1p31pDvtscO7X9wuTtJr1Snj0J6rGJrRwzRgjLKM
 oRWHxVxQvt7mtHStHfwt8+DhIiJvJD0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-240-iS_Tcj-fNH-QzI_YPkXnAw-1; Mon, 13 Jul 2020 12:32:16 -0400
X-MC-Unique: iS_Tcj-fNH-QzI_YPkXnAw-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B50B3100A8C5;
 Mon, 13 Jul 2020 16:32:14 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-112-113.rdu2.redhat.com
 [10.10.112.113])
 by smtp.corp.redhat.com (Postfix) with ESMTP id AD96272E47;
...
Date: Mon, 13 Jul 2020 17:32:07 +0100
Message-ID: <159465792794.1376674.7059263797738970966.stgit@warthog.procyon.org.uk>
...
X-Headers-End: 1jv1NT-001hM5-02
X-Mailman-Approved-At: Thu, 16 Jul 2020 08:18:34 +0000
Subject: [V9fs-developer] [PATCH 08/32] fscache: Replace the object
...
---
 ...
 28 files changed, 1019 insertions(+), 2000 deletions(-)
 create mode 100644 fs/fscache/obj.c
 delete mode 100644 fs/fscache/object.c
 create mode 100644 fs/fscache/object_bits.c

diff --git a/fs/afs/cell.c b/fs/afs/cell.c
index 7fdc39b1c965..1cdabbdeeb2c 100644
--- a/fs/afs/cell.c
+++ b/fs/afs/cell.c
@@ -613,7 +613,7 @@ static int afs_activate_cell(struct afs_net *net, struct afs_cell *cell)
 					     NULL,
...
+					     0);
 	...
 	if (ret < 0)
@@ -652,7 +652,7 @@ static void afs_deactivate_cell(struct afs_net *net, struct afs_cell *cell)
...
index 13f078111bad..75058de366a1 100644
--- a/fs/afs/file.c
+++ b/fs/afs/file.c
...
index 0a4623c38cf5..49d897437998 100644
--- a/fs/afs/inode.c
+++ b/fs/afs/inode.c
...
index 5e3fe894a0f9..13a953df5d75 100644
--- a/fs/afs/volume.c
+++ b/fs/afs/volume.c
...
index b868afb970ad..e4d1a82b9f33 100644
...
-
 		...
 		kmem_cache_free(cachefiles_object_jar, object);
@@ -416,15 +424,25 @@ static void cachefiles_invalidate_object(struct fscache_object *_object)
 	_leave("");
 }
...
index 818d1bca1904..d1c8828ebbbb 100644
...
@@ -288,7 +297,7 @@ int cachefiles_walk_to_object(struct cachefiles_object *parent,
...
index 92f747b72ec3..8f2dd40f93fb 100644
...
index aa33d16711e1..a8aa1639e93b 100644
...
index c8f1beafa8e1..b2691439377b 100644
--- a/fs/fscache/main.c
+++ b/fs/fscache/main.c
...
@@ -64,14 +61,6 @@ static int fscache_max_active_sysctl(struct ctl_table *table, int write,
 }
...
@@ -98,20 +87,8 @@ static struct ctl_table fscache_sysctls_root[] = {
  */
...
@@ -122,9 +99,6 @@ static int __init fscache_init(void)
 	if (!fscache_op_wq)
 		goto error_op_wq;
...
@@ -169,8 +143,6 @@ static int __init fscache_init(void)
 error_proc:
...
@@ -191,7 +163,6 @@ static void __exit fscache_exit(void)
...
index 000000000000..63373b99ac34
--- /dev/null
+++ b/fs/fscache/obj.c
@@ -0,0 +1,352 @@
+// SPDX-License-Identifier: GPL-2.0-or-later
...
index 5d50976bf379..000000000000
...
index 8b6aa11dee54..de1cffb2558e 100644
...
index c62b62938c4d..11b18761a3b6 100644
