...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A180A461844
	for <lists+v9fs-developer@lfdr.de>; Mon, 29 Nov 2021 15:26:57 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mrhcO-0005sO-7K; Mon, 29 Nov 2021 14:26:56 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1mrhcM-0005s8-Jn
 for v9fs-developer@lists.sourceforge.net; Mon, 29 Nov 2021 14:26:54 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=TuJeXBZzABBvebH6TbsfSw5ySf+nQYqZwrEw9kkWPlk=; b=KFWjQsSApDyg03CvIUSfR+tOpC
 5+14U1aVMP9WBVy8KeKvkLEKOcWqfzfq7FtE0I2Bl5mPkYDVsziKNIe3jmsVQwEjQJTAmtRCtD3bz
 qIVhofeUB4LRdnycd4ZBaA0SaMhU+Lgpcen8bt/yDJG7wq6m9K+E/HMiUaPZ4cco3kNo=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=TuJeXBZzABBvebH6TbsfSw5ySf+nQYqZwrEw9kkWPlk=; b=nV9ZjgzHpHquEYoIuLx3GFwtaK
 7p0H9TfbFCMHG75XE1fhllyLs4X1f01a6niQwRRlBbjH5UOV4XjLSDKuapUVc0DnwbL/R5Xphhk6i
 2c2jB33cBcWcB7E4VAKCrWHYNBGOtSzAmNnDX82q3Vq9DwvkjYyCTcE06DqYDdglzCMA=;
...
X-Spam-Report: Spam detection software,
 ...
 Three cache methods are provided: ->lookup_cookie() to look up and,
 if necessary, create a data storage object;
 ->withdraw_cookie() to free the resources associated
 with that object and potentially de [...] 
...
X-Headers-End: 1mrhcL-00EDTs-BQ
Subject: [V9fs-developer] [PATCH 17/64] fscache: Implement simple cookie
 state machine
