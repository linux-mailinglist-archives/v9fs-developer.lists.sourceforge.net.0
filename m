...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DA5F6C99C8
	for <lists+v9fs-developer@lfdr.de>; Mon, 27 Mar 2023 04:59:55 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1pgd5L-0003wK-Cv;
	Mon, 27 Mar 2023 02:59:52 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <ericvh@kernel.org>) id 1pgd5J-0003wE-OS
 for v9fs-developer@lists.sourceforge.net;
 Mon, 27 Mar 2023 02:59:50 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=+Zfx7JyEppmU0j2++/mJuU7wF1Jvxvi0uIcSZrd/e7g=; b=bK33VMZDVaHSKsz75bTEQwGika
 lXmwTWwhUp6ywY+tZ/wDXT7hc4gsIob1R9/PhT8YfFwIJ3Jhq+C0myKcTEX1R5pnECHOBUGKXKhlz
 GkgaIM3WN7xQ8dS03c6o8OhOS93aBqXaDDm/6hwqDsxu3uqeIdFDecxRmy0XeU03WQOA=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=+Zfx7JyEppmU0j2++/mJuU7wF1Jvxvi0uIcSZrd/e7g=; b=JCI/R1/2NFrbMH9BRaYMCuqKuL
 SiYCkzi/F1EyyT+dnvNDskbYm9EcVJoNbYu84gj86BlSa8umgauZ00EA4HyxNCqSXrZuey5cQOyiy
 GJbUCBGlGRLDaOnq7nSM4VlWQwhmCwyxRanrPpxwrpQ/dRFFdXrdT36bwVPt4BgGnBWQ=;
Received: from ams.source.kernel.org ([145.40.68.75])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pgd5J-0057lW-0x for v9fs-developer@lists.sourceforge.net;
 Mon, 27 Mar 2023 02:59:50 +0000
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by ams.source.kernel.org (Postfix) with ESMTPS id 9327BB80DA0;
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: This patch removes the creating of an additional
 writeback_fid
 for opened files. The patch addresses problems when files were opened
 write-only
 or getattr on files with dirty caches. This patch also incorporates
 information
 about cache behavior in the fid for every file. This allows us to reflect
 cache behavior from mount flags, open mode, and information from the server
 to inform [...] 
...
X-Headers-End: 1pgd5J-0057lW-0x
Subject: [V9fs-developer] [PATCH v5] fs/9p: remove writeback fid and fix
 per-file modes
