...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id D206E79E27
	for <lists+v9fs-developer@lfdr.de>; Tue, 30 Jul 2019 03:50:01 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1hsHH3-0005Xx-BS; Tue, 30 Jul 2019 01:49:57 +0000
...
Subject: [V9fs-developer] [PATCH 00/20] vfs: Add support for timestamp limits
...
Cc: lucho@ionkov.net, martin@omnibond.com, jfs-discussion@lists.sourceforge.net,
 shaggy@kernel.org, yuchao0@huawei.com, me@bobcopeland.com,
