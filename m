...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E55346F125
	for <lists+v9fs-developer@lfdr.de>; Thu,  9 Dec 2021 18:11:01 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mvMwc-0003PL-N8; Thu, 09 Dec 2021 17:10:59 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1mvMwa-0003OT-Mt
 for v9fs-developer@lists.sourceforge.net; Thu, 09 Dec 2021 17:10:57 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=Rey6vEtWwZSMJn5aNlBS81tWHUgmXpSSfNLu9mzBdcg=; b=ePdpM0IG8dU+s0a5MdcXhzAlJc
 LKCILTdK8/ab2MlrIExQaLt0VKxhtKuIfUcb4E0Y9FS0VwD4DFMW3DWcHhEL4U09/8IoYLiH9tplR
 qcitfo7O0wqFWFw1/mFUQjNVjqeHkqPyn3lt3i7/OQfhuFx/aktl8UOO21BN3AwXCF70=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=Rey6vEtWwZSMJn5aNlBS81tWHUgmXpSSfNLu9mzBdcg=; b=glFAc4ypOszjbKlLfyNt4x+O/7
 Q2alKWcN0aDXcTLl5DLz85FcyFJ2phm/NJPKlmUJlD+ajtCF4Wh7RWggdQRj+alAPT5edbBv8EVsL
 6FnG9Nj1lghMfKO8gGnvMessmP97h0wIUrxTxZD3CVVpvzvN5ZqcTagYxETWXYvoOmY8=;
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 id 1mvMwR-0001Z3-OB
 for v9fs-developer@lists.sourceforge.net; Thu, 09 Dec 2021 17:10:49 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1639069841;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=Rey6vEtWwZSMJn5aNlBS81tWHUgmXpSSfNLu9mzBdcg=;
 b=hnioEMqubaaG0B5d4+15VT5J3pGFh6Xq+sk6D4cjX+Kwji0C8x9T/bYXMJRUaycSpjDOZi
 bbEhm2JVtb/2mXseC6VD+ZZ+Rew4uxkl58Th/KYiJshS0ycuLqgcivO1ksi97tOyx338mN
 l0Sm4Lzs1nFlIQZxQYdf0/6slQAwTmQ=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-148-rBxnpEdbNfyvT-T67nkHkw-1; Thu, 09 Dec 2021 12:10:40 -0500
X-MC-Unique: rBxnpEdbNfyvT-T67nkHkw-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
 [10.5.11.14])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 890EA81CCB5;
 Thu,  9 Dec 2021 17:10:37 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.122])
 by smtp.corp.redhat.com (Postfix) with ESMTP id A7A8F5D9D5;
 Thu,  9 Dec 2021 17:10:30 +0000 (UTC)
...
Date: Thu, 09 Dec 2021 17:10:29 +0000
Message-ID: <163906982979.143852.10672081929614953210.stgit@warthog.procyon.org.uk>
...
X-Headers-End: 1mvMwR-0001Z3-OB
Subject: [V9fs-developer] [PATCH v2 64/67] cifs: Support fscache indexing
 rewrite (untested)
...
---
 ...
 fs/cifs/inode.c    |   36 ++++--
 10 files changed, 175 insertions(+), 487 deletions(-)
...
index 9fee3af83a73..94f5c884a4f9 100644
--- a/fs/cifs/file.c
+++ b/fs/cifs/file.c
...
index 003c5f1f4dfb..47270f96439f 100644
--- a/fs/cifs/fscache.c
+++ b/fs/cifs/fscache.c
@@ -12,250 +12,138 @@
...
+	return -ENOBUFS; // Needs conversion to using netfslib
 ...
 /*
@@ -266,78 +154,19 @@ int __cifs_readpages_from_fscache(struct inode *inode,
...
index 9baa1d0f22bd..cf4b04317149 100644
--- a/fs/cifs/fscache.h
+++ b/fs/cifs/fscache.h
@@ -13,8 +13,6 @@
...
index 96d083db1737..dc2fe76450b9 100644
--- a/fs/cifs/inode.c
+++ b/fs/cifs/inode.c
