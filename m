...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id BB2A64D6021
	for <lists+v9fs-developer@lfdr.de>; Fri, 11 Mar 2022 11:52:09 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nScsT-0007Q0-CZ; Fri, 11 Mar 2022 10:52:08 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <jgross@suse.com>) id 1nScsR-0007Pt-8s
 for v9fs-developer@lists.sourceforge.net; Fri, 11 Mar 2022 10:52:06 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=nZEvYyMBPYN1QtFdkQaMVNyj0XKkJ4elnymAYBJb21k=; b=Mw+ahMKbXeka3Hj6b5iHhxW2qv
 zUBHohyFebaFyU4+fxMg6C+BeJDbpmFGogzXfG9q6+nwVP6k7LnxBa9Ao9Sfm1cGh5v6SN91cOJ6Z
 c1AFzH4ECPn2fq8rLtbT23HMkMXrzOZLwjZI6E560ZIZXI0+RsutFj+jh89k/HRVm/4Y=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=nZEvYyMBPYN1QtFdkQaMVNyj0XKkJ4elnymAYBJb21k=; b=jrhqYqpebP0LzRI/JCGpYxYZ9t
 61pF3kpDCfy3HWJTv9Pq15v7wQwF2hcW/pQxBtkZgNqaLYY2yY32rAdrm0V7aEHsKblhpZCHPNgAk
 nuvRzzW/YZ119Z/nsa6uQ0kIM/UY+1W4fo45W4NOCumrJjv/MqOjy9Xfw29gzc8noH9w=;
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: The gnttab_end_foreign_access() family of functions is taking
 a "readonly" parameter,
 which isn't used. Remove it from the function parameters.
 Signed-off-by: Juergen Gross <jgross@suse.com> ---
 drivers/block/xen-blkfront.c
 | 8 ++--- drivers/char/tpm/xen-tpmfront.c | 2 +-
 drivers/gpu/drm/xen/xen_drm_front_evtchnl.c
 | 2 +- drivers/input/misc/x [...] 
...
X-Headers-End: 1nScsL-00C21w-OW
Subject: [V9fs-developer] [PATCH 2/2] xen/grant-table: remove readonly
