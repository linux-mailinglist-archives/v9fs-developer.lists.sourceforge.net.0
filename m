...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 563F64D4E50
	for <lists+v9fs-developer@lfdr.de>; Thu, 10 Mar 2022 17:15:41 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nSLS1-0000Qa-2J; Thu, 10 Mar 2022 16:15:39 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1nSLRz-0000QT-Ek
 for v9fs-developer@lists.sourceforge.net; Thu, 10 Mar 2022 16:15:38 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=mNYnzPwF/W1EEadaIfirFng79KpXCXLNJYWScniVotg=; b=NfCpu6PCDizspN7dV/6c5b3PLR
 eKo8QTuqCRftdzK43h2dw77+DT1gAy9T/30MbIR5yZqGUlR2xdzP5ThnQozzsKFKnufIl1yEbmgZN
 5BvkHTPUi1jktuZLy8AGXkilVE2pISFuRwOdNFr7YIe2UkocjaXrcHg2YdAlZKiKVB0o=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=mNYnzPwF/W1EEadaIfirFng79KpXCXLNJYWScniVotg=; b=T28dyef7Is2sC+TmdeIbPCVX+/
 ZHTkMMF431hUjEVB3U9WXBkI2UDM7tygxhwJEATrYzaO5K/WSTuSMOSpG0wIT3RVtQZ7dIoKYM4c7
 G67m/ogNJAKZ0l3e6kMve3FWa5uSbev2oWw3eH+S6bU1TVR/j+bc9HH68P28GDcrXBtc=;
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.94.2)
 id 1nSLRv-00B60M-Nn
 for v9fs-developer@lists.sourceforge.net; Thu, 10 Mar 2022 16:15:37 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1646928926;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=mNYnzPwF/W1EEadaIfirFng79KpXCXLNJYWScniVotg=;
 b=LleYfxqPx8wq+Z2HuyynWpCO0qmFepq9LNUbTZ9zApIb8K+BPhYEFpXIp1ZbY+AO5RRg0L
 2D+eVLisgFIJYlMc641xau5TCriGCyP+KC6ZtheY7cudUS/inn+ZvqKVDCEVLehSO3XQ9y
 fR0Px/nexdIG1rL8+2PxYpmpw1LSOeU=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-670-IPIn8APWMxGBk7NN_SnDfw-1; Thu, 10 Mar 2022 11:15:22 -0500
X-MC-Unique: IPIn8APWMxGBk7NN_SnDfw-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 6C9CB51EA;
 Thu, 10 Mar 2022 16:15:20 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.19])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 3586586591;
 Thu, 10 Mar 2022 16:15:16 +0000 (UTC)
...
Date: Thu, 10 Mar 2022 16:15:15 +0000
Message-ID: <164692891535.2099075.18435198075367420588.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: Rename netfs_read_*request to netfs_io_*request so that the
 same structures can be used for the write helpers too. perl -p -i -e
 's/netfs_read_(request|subrequest)/netfs_io_$1/g'
 \ `git grep -l 'netfs_read_\(sub\|\)request'` perl -p -i -e
 's/nr_rd_ops/nr_outstanding/g'
 \ `git grep -l nr_rd_ops` perl -p -i -e 's/nr [...] 
...
X-Headers-End: 1nSLRv-00B60M-Nn
Subject: [V9fs-developer] [PATCH v3 03/20] netfs: Rename netfs_read_*request
 to netfs_io_*request
...
index 4d0bf02d490a..b40809c0bd74 100644
