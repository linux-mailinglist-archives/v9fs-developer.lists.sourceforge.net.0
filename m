...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C69E4D31D0
	for <lists+v9fs-developer@lfdr.de>; Wed,  9 Mar 2022 16:31:52 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nRyI2-0008Bl-O7; Wed, 09 Mar 2022 15:31:49 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <jlayton@kernel.org>) id 1nRyI1-0008Bd-32
 for v9fs-developer@lists.sourceforge.net; Wed, 09 Mar 2022 15:31:47 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=/NPrTUKuHtNyJ8xBp7yApm4Usrgy7VDbMu9uxYj7ynU=; b=T/+dZtLAIWqLIWcmmSSUZV/62C
 0IiQIPFmENR0/vk6m35d7w+2dhS/STsPSoPfM6+o2s3eiv9bdfabJyAaSxeJSUJEfYQR+CUHgfQUS
 zk3JtAPXI0R0B5w1fiD0FXXkw/SAwoIQcB6CZ75mn2oskpSp9e5hpm3CNuX+rTejOyHA=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=/NPrTUKuHtNyJ8xBp7yApm4Usrgy7VDbMu9uxYj7ynU=; b=LIVkR9zB4n/rAjIRXOfQKaLxYX
 daKN3H0regRaQ0AuLE292JQ0Bq3XN/kkaXMHSog7U8vS6E3czX89p+1Aa+ROQAM9JWD2N49vEXppI
 jnepOTlGVXClZ7CIf1xLnUCRXC9oyNhUNlhGuPTasfdhKLiFkWcZuvA63az6HbeCQqmc=;
...
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 ...
 by ams.source.kernel.org (Postfix) with ESMTPS id 5893BB8220A;
 Wed,  9 Mar 2022 15:31:38 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 82BE1C340E8;
 Wed,  9 Mar 2022 15:31:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1646839897;
 bh=8OV8X3Ds/uVst6mqoHb7XlRtagfpsAjjBrW3e+WlShU=;
 h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
 b=
Message-ID: <e4d6563510798b808082f5b525d84a4121d2537f.camel@kernel.org>
From: Jeff Layton <jlayton@kernel.org>
To: David Howells <dhowells@redhat.com>, linux-cachefs@redhat.com
Date: Wed, 09 Mar 2022 10:31:34 -0500
In-Reply-To: <164678195157.1200972.366609966927368090.stgit@warthog.procyon.org.uk>
References: <164678185692.1200972.597611902374126174.stgit@warthog.procyon.org.uk>
 <164678195157.1200972.366609966927368090.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 > can be used for the write helpers too. > > perl -p -i -e 's/netf [...] 
...
X-Headers-End: 1nRyHx-009rrh-2w
Subject: Re: [V9fs-developer] [PATCH v2 03/19] netfs: Rename
 netfs_read_*request to netfs_io_*request
