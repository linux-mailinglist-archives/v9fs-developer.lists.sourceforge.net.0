...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 451CD94D06
	for <lists+v9fs-developer@lfdr.de>; Mon, 19 Aug 2019 20:33:34 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=duzzUENik3sniI7jKwma7/xlZ2MRLrXOrS4WD7ZI4r0=; b=aDMD7fJqs1cAqHIRZqzfip12H6
	rx6+9jYPqr0sS+JbBUsRl6GHpHGu9mE5IBg7TFfYpSLdG7OSx9WXDdCI6B2diOln2CJ3upOiiIXxx
	PO4Lydf75vYkgc5WTjQYw8j8VNU2yMspiFNWXNY/Cz+w17Q6iUbyOoBIW5hoRLqZ89U8=;
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1hzmTB-0001Ev-Jv; Mon, 19 Aug 2019 18:33:29 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <salyzyn@android.com>) id 1hzmT9-0001Eb-G6
 for v9fs-developer@lists.sourceforge.net; Mon, 19 Aug 2019 18:33:27 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=gDJOib20l4BIE8/agtg6EWDCN2zDI/0KAGuVFsJE8l0=; b=nMow1zbCakwjTqHaNss2EAW4GK
 /QYGpOojBqKZvmt3AsNaiF/tenv6zf9GJyiY3V6YoNQEfujETHGyFmdNjrql0PGqLWGswFzCnyZxP
 Tc02Y4wEd1M2ayWo4HmrgAwqhTvXq1+6BmyuaRLxFhBnoeILgdQxwGuzZhUDx7zW8+pg=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=gDJOib20l4BIE8/agtg6EWDCN2zDI/0KAGuVFsJE8l0=; b=d
 UOyr5lLGQUwlNkyYKI0IgoT88yq227bVuWbrEps8xcw2v2SeLe47C3O4J+IIrM3CQeKbdE4JeED7A
 jwJaJ6aZtWRD7tIbTtmp+C6NyAvZB39KJya6t2RxOWsmuMQkb4MpqyRkSvihJyI+naDMGX2iz17ll
 cm/G1y4LOuIWm7OI=;
Received: from mail-pf1-f194.google.com ([209.85.210.194])
 ...
 id 1hzmT4-008W8h-Ng
 for v9fs-developer@lists.sourceforge.net; Mon, 19 Aug 2019 18:33:27 +0000
Received: by mail-pf1-f194.google.com with SMTP id f17so1654409pfn.6
 for <v9fs-developer@lists.sourceforge.net>;
 Mon, 19 Aug 2019 11:33:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=android.com; s=20161025;
 h=from:to:cc:subject:date:message-id:mime-version
 :content-transfer-encoding;
 bh=gDJOib20l4BIE8/agtg6EWDCN2zDI/0KAGuVFsJE8l0=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=gDJOib20l4BIE8/agtg6EWDCN2zDI/0KAGuVFsJE8l0=;
 b=
X-Gm-Message-State: APjAAAU5r5PcjW3vbWFr4l0SHYu5sf/bS0nx/w4NQr6E9lACYQplV4WX
 oGbhOT9EHJdVCHtEdneL3iXGIA==
X-Google-Smtp-Source: APXvYqzOjQNcp3Mz4aESeuidhfBwAZWtUamsAQTH0ptLY3uymn0mseFwtmDLSUDzDyTnFNexw/bEGw==
X-Received: by 2002:a17:90a:800a:: with SMTP id
 b10mr21492396pjn.23.1566239596064; 
 Mon, 19 Aug 2019 11:33:16 -0700 (PDT)
Received: from nebulus.mtv.corp.google.com
 ([2620:15c:211:200:5404:91ba:59dc:9400])
 by smtp.gmail.com with ESMTPSA id i9sm16043238pgg.38.2019.08.19.11.33.12
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 19 Aug 2019 11:33:14 -0700 (PDT)
To: linux-kernel@vger.kernel.org
Date: Mon, 19 Aug 2019 11:32:26 -0700
Message-Id: <20190819183305.153583-1-salyzyn@android.com>
...
X-Headers-End: 1hzmT4-008W8h-Ng
Subject: [V9fs-developer] [PATCH v5] Add flags option to get xattr method
...
---
 ...
 55 files changed, 715 insertions(+), 719 deletions(-)
...
@@ -289,15 +289,15 @@ static int v9fs_xattr_set_acl(const struct xattr_handler *handler,
 				 * update ACL.
 				 */
...
@@ -309,7 +309,8 @@ static int v9fs_xattr_set_acl(const struct xattr_handler *handler,
 	default:
 		BUG();
 	}
...
index f3f3984cce80..29d972015480 100644
--- a/fs/kernfs/inode.c
+++ b/fs/kernfs/inode.c
...
@@ -282,17 +282,24 @@ static struct smack_known *smk_fetch(const char *name, struct inode *ip,
 					struct dentry *dp)
 {
 	int rc;
-	char *buffer;
