...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EE4B4C6993
	for <lists+v9fs-developer@lfdr.de>; Mon, 28 Feb 2022 12:09:17 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1nOdu1-0004Rc-1Z; Mon, 28 Feb 2022 11:09:15 +0000
...
Subject: [V9fs-developer] [PATCH 1/6] drivers: usb: remove usage of list
