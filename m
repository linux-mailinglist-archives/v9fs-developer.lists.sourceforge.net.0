...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F83B43206B
	for <lists+v9fs-developer@lfdr.de>; Mon, 18 Oct 2021 16:53:15 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.92.3)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mcU0n-0006XB-OT; Mon, 18 Oct 2021 14:53:13 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 (envelope-from <dhowells@redhat.com>) id 1mcU0l-0006W6-VV
 for v9fs-developer@lists.sourceforge.net; Mon, 18 Oct 2021 14:53:12 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=0ZKaCE4fwSVwbGKf5RO8OE+FE/li2jRhDZ1Q5Np39cs=; b=UbjWuSDVIFUNvuv83BCwnprzJr
 8FsKWTk+BzuU6lvaewVC62qiht39t/MJDcJQCmq39K3bBkSBy5pa9UNHLpD0CMEiVWvfbnzrlqd/T
 /LvrEjuWlYpwSOj1p8MiR6SBw6B8rfrvILlKwKg9xcn8x1rC3HVT3/b/t8+CjeNa9oAI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=0ZKaCE4fwSVwbGKf5RO8OE+FE/li2jRhDZ1Q5Np39cs=; b=iCDqg7XrTW6qMNzqH8yv63bllc
 yxoQaNs4GLmZ5V82WX7E6kvufXQo0yDFU3UTkv5xdvFXGnXmSXE7+8lkVOuIicssHQBxcO/nkZgXJ
 27XjAUam0zeR0owcDli+BSeGBgqNloyQYxAPn9DN7SkgRQTLVRHDiF3mULUKEUkW+MYs=;
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 id 1mcU0Y-0003O7-RL
 for v9fs-developer@lists.sourceforge.net; Mon, 18 Oct 2021 14:53:00 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Remove the cookie definition structure so that there's no
 pointers from that back into the network filesystem. All of the method
 pointers
 that were in there have been removed anyway. Any remaining inf [...] 
...
X-Headers-End: 1mcU0Y-0003O7-RL
Subject: [V9fs-developer] [PATCH 08/67] fscache: Remove struct
 fscache_cookie_def
