...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A5143917F6
	for <lists+v9fs-developer@lfdr.de>; Sun, 18 Aug 2019 18:59:35 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1hzOWh-00088b-CA; Sun, 18 Aug 2019 16:59:31 +0000
...
Subject: [V9fs-developer] [PATCH v8 00/20] vfs: Add support for timestamp
 limits
...
Cc: lucho@ionkov.net, martin@omnibond.com, jfs-discussion@lists.sourceforge.net,
 ...
 dushistov@mail.ru, keescook@chromium.org, arnd@arndb.de, ericvh@gmail.com,
 jack@suse.com, reiserfs-devel@vger.kernel.org, tj@kernel.org,
 jlbec@evilplan.org, aivazian.tigran@gmail.com, phillip@squashfs.org.uk,
