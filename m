...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 67C9C43FE20
	for <lists+v9fs-developer@lfdr.de>; Fri, 29 Oct 2021 16:11:44 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <v9fs-developer-bounces@lists.sourceforge.net>)
	id 1mgSbe-0000yv-Bn; Fri, 29 Oct 2021 14:11:42 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <dhowells@redhat.com>) id 1mgSbc-0000yj-Ja
 for v9fs-developer@lists.sourceforge.net; Fri, 29 Oct 2021 14:11:41 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=3Y38K+ADx0aeRe7jYyZYCqDbNuU7ipJUISKBiOxfTTs=; b=hjV2qVkru6DnIi8Gu8IKL9hVMt
 t8NjtbZkxhSWHjYWd+/2XGb0GU1cvod/ZjGBh2QiC7xRQv8tt8CAikKxhgr0hqFeK42ySSvEz23tt
 +T+w2Pg/UIhpoKaIu9ErSTQwN58PvEU1xhmoKHan6Jak3awz+AwIGrfk8ljZdr0vIFGQ=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=3Y38K+ADx0aeRe7jYyZYCqDbNuU7ipJUISKBiOxfTTs=; b=Rs296EJ5pZgweVQkLw4rid7u9M
 iGiTgHxcwT9pF1z4BdAcU0kIlBB1hGK5w6vL43PYJe1dGQxNeFxqm/CcdqATNHy9644XaNCvGgWo2
 WjWZ31eGEXkuOQH/Z7EKdrj4/mMxY7LgEFba6CdrHvJFOXEW6L3MCDfW5sDuIaV9x2Nw=;
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 id 1mgSbV-005kzm-K1
 for v9fs-developer@lists.sourceforge.net; Fri, 29 Oct 2021 14:11:40 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1635516687;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=3Y38K+ADx0aeRe7jYyZYCqDbNuU7ipJUISKBiOxfTTs=;
 b=cLrEBUQi+6T/CbOiazotyFbpqL3YG5c2eptINN2NUD74VfYWl2r+mYDxWok7Tovf+S2IxY
 9NMiNdyRbjgNn771mowr5P1H3b0l/incKsg9i9faDMGgSFmfLFDUbXuN4HtWNFxNTHlrQD
 MYs3eg2dDpfN8LxOOHUvQpzupdOZrTY=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-364-pgDg8pioNbuNAXqS9ByE8A-1; Fri, 29 Oct 2021 10:11:24 -0400
X-MC-Unique: pgDg8pioNbuNAXqS9ByE8A-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com
 [10.5.11.12])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 63B4D18414A2;
 Fri, 29 Oct 2021 14:11:22 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.19])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 6F54E60C17;
 Fri, 29 Oct 2021 14:11:05 +0000 (UTC)
...
Date: Fri, 29 Oct 2021 15:11:04 +0100
Message-ID: <163551666461.1877519.11215118047756175525.stgit@warthog.procyon.org.uk>
...
X-Spam-Report: Spam detection software,
 ...
 Content preview:  Remove the old fscache I/O API. There's no point trying to
 transform it as the new one bears no similarities to the old one.
 Signed-off-by:
 David Howells <dhowells@redhat.com> cc: linux-cachefs@redhat.com Link:
 https://lore.kernel.org/r/158861213535.340223.11422037188513966130.stgit@warthog.procyon.org.uk/
 # fscache rewrite [...] 
...
X-Headers-End: 1mgSbV-005kzm-K1
Subject: [V9fs-developer] [PATCH v4 08/10] fscache: Remove the old I/O API
...
Link: https://lore.kernel.org/r/163189113658.2509237.9999467212589051557.stgit@warthog.procyon.org.uk/ # rfc v2
---
...
index 6a675652129b..86ad941726f7 100644
...
index 715fb830e982..01558d155799 100644
...
@@ -193,7 +164,6 @@ extern void __fscache_update_cookie(struct fscache_cookie *, const void *);
...
-
 ...
 extern int __fscache_begin_operation(struct netfs_cache_resources *, struct fscache_cookie *,
 				     bool);
@@ -202,33 +172,6 @@ extern int __fscache_begin_operation(struct netfs_cache_resources *, struct fsca
...
-
 ...
 extern void __fscache_enable_cookie(struct fscache_cookie *, const void *, loff_t,
 				    bool (*)(void *), void *);
@@ -495,24 +438,6 @@ void fscache_wait_on_invalidate(struct fscache_cookie *cookie)
...
-
 ...
 /**
@@ -619,289 +544,6 @@ int fscache_write(struct netfs_cache_resources *cres,
